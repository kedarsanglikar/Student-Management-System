...
public class AddMarks extends javax.swing.JFrame {
    ...
    public static String getSubjectValue(String tableName, String subjectName) {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:sqlserver://DESKTOP-1GNNH8U:1433;databaseName=student_section;user=sa;password=admin@123456789;encrypt=true;trustServerCertificate=true")) {
...
System.out.println(sub5);
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:sqlserver://DESKTOP-1GNNH8U:1433;databaseName=student_section;user=sa;password=admin@123456789;encrypt=true;trustServerCertificate=true");
            if (conn == null) {
...
//           }
    ...
    private void checkIfAdmittedBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkIfAdmittedBtnActionPerformed
        ...
        try {
            ...
            searchQuery = "select Name from student_section.dbo.StdRegi1 where PRN='" + PRN + "';";
